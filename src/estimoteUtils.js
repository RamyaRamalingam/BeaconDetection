...
import { estimoteAppConfig } from "./credentials/estimoteAppDetails";

export const startProximityObserver = () => {

  const ESTIMOTE_APP_ID = estimoteAppConfig.ESTIMOTE_APP_ID;
  const ESTIMOTE_APP_TOKEN = estimoteAppConfig.ESTIMOTE_APP_TOKEN;

  const zone1 = new RNEP.ProximityZone(5, "section");
...
export const stopProximityObserver = () => { RNEP.proximityObserver.stopObservingZones(); };
